...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    vec3 c1 = vec3(step(ray, 0.6));
	c1 *= vec3(0.047,0.209,0.950); 
    
    vec3 c2 = vec3(step(ray2, 0.6));
	c2 *= vec3(0.305,0.044,0.950);
